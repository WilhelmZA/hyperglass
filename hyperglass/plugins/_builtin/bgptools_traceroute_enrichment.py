"""BGP.tools and DNS enrichment for structured traceroute data only."""
...
class ZBgpToolsTracerouteEnrichment(OutputPlugin):
    """Enrich structured traceroute output with BGP.tools ASN/organization data and reverse DNS."""
