---
title: Reverse Proxy
description: Set up a reverse proxy for Ultraglass
---
...
Change the `lg.example.com` and `person@example.com` values to match your Ultraglass FQDN and email address. The email address is used for automatic SSL certificate generation via Let's Encrypt.
...
Change the `lg.example.com` value to match your Ultraglass FQDN.
