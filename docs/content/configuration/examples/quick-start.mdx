...
Here are common configuration patterns to get you started with Ultraglass. For the full list of options, see the [Complete Configuration Reference](/configuration/config/complete-config).
...
web:
  ...
  greeting:
    ...
    content: |
      ...
      This is a development and testing instance of Ultraglass.
...
Place your `config.yaml` file in the Ultraglass configuration directory:
