...
Ultraglass includes several built-in [directives](/configuration/directives.mdx), and you can add your own. For example, you might add a command that shows the BGP summary from a device:
