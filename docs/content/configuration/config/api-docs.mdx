...
Ultraglass automatically generates documentation for the REST API. The `docs` section allows administrators to customise the look, feel, and text used for that documentation.

| Parameter          | Type    | Default Value                  | Description                                                                                     |
| :----------------- | :------ | :----------------------------- | :---------------------------------------------------------------------------------------------- |
| `docs.base_url`    | String  | https://lg.example.com         | Used for REST API samples. Open `/api/docs` on your deployment to view the generated documentation. |
