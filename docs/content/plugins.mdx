---
title: Plugins
description: Ultraglass plugins
---

import { Cards, Card } from "nextra/components";

Ultraglass supports custom plugins. There are two main types of plugins:
...
In this example, the following query is sent to Ultraglass:
